...
public class GCexample {
    ...
    public static void main(String[] args) {
        ...
        Cleaner.Cleanable cleanable1=cleaner.register(obj1,new GCexample.CleanableResource("object 1"));
        Cleaner.Cleanable cleanable2=cleaner.register(obj2,new GCexample.CleanableResource("object 2"));
        Cleaner.Cleanable cleanable3=cleaner.register(obj3,new GCexample.CleanableResource("object 3"));
